...
b. A new observation with linoleic acid equal to 1000 would be classified into which region? Sardinia or North

## Question 2

The pooled variance is the same as the variance across all groups. TRUE or FALSE

## Question 3

If the prior probability for group 1 is higher than group 2, the LDA boundary is actually shifted towards group 1? YES or NO

## Question 4

Compute the classification error from the tabulation of true class vs predicted class below. 
