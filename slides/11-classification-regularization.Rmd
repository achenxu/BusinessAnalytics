...
$$maximize_{\beta_k}{\beta^T_k} \hat{\Sigma}^k_b\beta_k -P_k(\beta_k)$$ subject to $$\beta^T_k \hat{\Sigma}_w\beta_k \leq 1$$

where $\hat{\Sigma}^k_b = \frac{1}{n}X^TY(Y^TY)^{-1/2}P^\bot_k(Y^TY)^{-1/2}Y^TX$, and
$\hat{\Sigma}_w$ is within group sum of squares.
