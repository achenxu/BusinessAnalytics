...
\begin{tabular}{ll}
\raisebox{-1cm}{\includegraphics[width=2.5cm]{souhaib}} & Souhaib Ben Taieb \\
\raisebox{-1cm}{\includegraphics[width=2.5cm]{di}}& Di Cook \\
\raisebox{-1cm}{\includegraphics[width=2.5cm]{rob}}& Rob Hyndman
\end{tabular}
...
\begin{enumerate}
\item \only<3>{\alert}{Actuary}
\item Audiologist
\item \only<3>{\alert}{Mathematician}
\item \only<3>{\alert}{Statistician}
\item Biomedical Engineer
\item \only<3>{\alert}{Data Scientist}
