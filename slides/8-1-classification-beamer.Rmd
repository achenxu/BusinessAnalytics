...
```{r flea-ds, cache=FALSE, echo=FALSE, warning=FALSE, error=FALSE, message=FALSE, fig.width=5, fig.height=5, fig.align="right"}
...
Different fields have different names for the same components of classification. Here is a glossary:
