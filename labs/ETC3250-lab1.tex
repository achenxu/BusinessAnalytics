...
\usepackage{titling,hyperref,url,microtype}
...
\item The \verb|summary| command can be applied to almost anything to get a summary of the object. Try it on some other data sets in the \verb|ISLR| package. Note that the \verb|summary| is just what R thinks should be the summary, and it may not always be the best summary. If someone asks you to "summarise" this data, you may need to think about what is important and use different functions that are appropriate for the situation.
